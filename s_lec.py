...
print(round(stats.binom.pmf(85,100,0.8),2)) #0.04806
...
print(round(stats.poisson.pmf(0,2), 2))

# Какова вероятность, что перегорят ровно две?
print(round(stats.poisson.pmf(2,2), 2))
# 3. Монету подбросили 144 раза.
# Какова вероятность, что орел выпадет ровно 70 раз?
print(round(stats.binom.pmf(70,144,0.5),2))
